            ...
            <div className="lg:col-span-4 col-span-12 flex justify-center">
              <div className="text-center -mt-20">
                <div className="relative mx-auto w-28 h-28">
                  ...
                  {user?.is_verified && (
                    <span className="absolute -bottom-1 -right-1 inline-flex items-center justify-center w-8 h-8 rounded-full bg-white dark:bg-gray-900 border border-lightprimary dark:border-lightprimary shadow text-primary z-10">
